...
$output .= '<th class="data-rank">' . esc_html__( 'Pos', 'champion' ) . '</th>';
...
if ( $show_full_table_link )
	$output .= '<div class="sp-league-table-link sp-view-all-link"><a href="' . esc_url(get_permalink( $id )) . '">' . esc_html__( 'View full table', 'champion' ) . '</a></div>';
?>
