...
class TitleEditorPage {
    ...
    private function resolveNotice(): ?array {
        ...
        return match ( $key ) {
            ...
            'fila_agregada_sin_vinculo' => [ 'message' => __( 'El jugador fue agregado al plantel, pero no se pudo evaluar su vínculo. Vinculalo manualmente aquí abajo, o volvé al listado de títulos y usá "Revalidar".', 'entre-redes-campeones' ), 'type' => 'warning' ],
            ...
            'fila_actualizada_sin_vinculo' => [ 'message' => __( 'La fila fue actualizada, pero no se pudo re-evaluar su vínculo. Vinculalo manualmente aquí abajo, o volvé al listado de títulos y usá "Revalidar".', 'entre-redes-campeones' ), 'type' => 'warning' ],
